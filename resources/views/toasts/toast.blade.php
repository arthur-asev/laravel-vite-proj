<div class="pointer-events-auto mx-5 my-5 absolute hidden w-96   max-w-full rounded-lg bg-primary-100 bg-clip-padding text-sm text-primary-700 shadow-lg shadow-black/5 data-[te-toast-show]:block data-[te-toast-hide]:hidden"
    id="static-example" data-te-toast-position="top-right" aria-live="assertive" aria-atomic="true" data-te-autohide="true" data-te-delay="1500"
    data-te-toast-init >
    <div
...
<div class="pointer-events-auto mx-5 my-5 absolute hidden w-96  max-w-full rounded-lg bg-success-100 bg-clip-padding text-sm text-success-700 shadow-lg shadow-black/5 data-[te-toast-show]:block data-[te-toast-hide]:hidden"
    id="toast-success" data-te-toast-position="top-right" aria-live="assertive" aria-atomic="true" data-te-autohide="true" data-te-delay="1500"
    data-te-toast-init >
    <div
...
<div class="pointer-events-auto mx-5 my-5 absolute hidden w-96   max-w-full rounded-lg bg-warning-100 bg-clip-padding text-sm text-warning-700 shadow-lg shadow-black/5 data-[te-toast-show]:block data-[te-toast-hide]:hidden"
    id="static-example" data-te-toast-position="top-right" aria-live="assertive" aria-atomic="true" data-te-autohide="true" data-te-delay="1500"
    data-te-toast-init >
    <div
...
<div class="pointer-events-auto mx-5 my-5 absolute hidden w-96  max-w-full rounded-lg bg-danger-100 bg-clip-padding text-sm text-danger-700 shadow-lg shadow-black/5 data-[te-toast-show]:block data-[te-toast-hide]:hidden"
    id="static-example" data-te-toast-position="top-right" aria-live="assertive" aria-atomic="true" data-te-autohide="true" data-te-delay="1500"
    data-te-toast-init >
    <div
